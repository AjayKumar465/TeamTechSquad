...
$(function(){
    demo.showNotification("top","right","<%=request.getAttribute("msgType")%>","<%=loginMsg%>",1000);
});
</script>
<%
}else{
...
<script>
$(function(){
    demo.showNotification("top","right","rose","Welcome to Nutrient's On a Click",1000);
});
	</script>
	<%
}
					...
					<form class="form" method="post" action="login">
						<div class="card card-login card-hidden">
							...
							<div class="card-footer justify-content-center">
								<input type="submit" class="btn btn-rose btn-link btn-lg" value="Lets
									Go">
									
							</div>
							<div style="margin-left:27px;text-decoration: underline;">
